...
OIDC/JWKS、PostgreSQL RLS、私有对象存储、加密交互重放、OpenAI 兼容 provider、outbox worker、HTTP 指标和本地负载/故障演练已经实现。真实 provider 质量、安全专项、staging、签名制品、灾难恢复和生产批准仍是发布门禁。[构建与发布](/build-release/) 定义证据与审批路径。
