...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Text and voice question answering  | `contracts/openapi.yaml` `/v1/ask`; `src/application/`; `src/server.ts`                                                              | contract, application-service and media-boundary tests                                 |
| ASR, intent and key information    | `src/providers.ts` adapters; generated `Understanding` schema                                                                        | provider capability, audio and review-policy tests                                     |
