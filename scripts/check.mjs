...
const required = [
  ...
  "contracts/control-plane-policy.json",
  "contracts/control-plane-policy.schema.json",
  ...
  "docs/ADR-0007-declarative-agent-control-plane.md",
  ...
  "docs/zh-cn/adr-0007-declarative-agent-control-plane.md",
