...
const runtimeSources = ["src/application/attachments.mjs", "src/application/commands.mjs", "src/application/index.mjs", "src/application/mutation-policy.mjs", "src/application/services.mjs", "src/auth.mjs", "src/composition-root.mjs", "src/control/cas-circuit-breaker.mjs", "src/control/engine.mjs", "src/control/index.mjs", "src/contracts.mjs", "src/data-cipher.mjs", "src/extensions/index.mjs", "src/extensions/manifest.mjs", "src/extensions/registry.mjs", "src/lifecycle/staged-timeout.mjs", "src/mutation-policy.mjs", "src/object-storage.mjs", "src/observability.mjs", "src/outbox-relay.mjs", "src/outbox-worker.mjs", "src/provider-common.mjs", "src/provider-dashscope.mjs", "src/provider-mock.mjs", "src/provider-openai.mjs", "src/providers.mjs", "src/production-config.mjs", "src/protocol-policy.mjs", "src/protocol-validation.mjs", "src/postgres-store.mjs", "src/server.mjs", "src/sse-adapter.mjs", "src/store.mjs"];
const required = ["README.md", "AGENTS.md", "LICENSE", "contracts/openapi.yaml", "contracts/events.yaml", "db/migrations/001_initial.sql", "db/migrations/002_interaction_control_wal.sql", "db/tests/001_rls_and_atomicity.sql", "protocol/protocol.manifest.json", "protocol/protocol-manifest.schema.json", "protocol/schema/json/openapi.bundle.json", "protocol/schema/json/events.bundle.json", "packages/api-client/src/api.ts", "packages/api-client/src/protocol.ts", "packages/api-client/src/generated/index.ts", ".mcp.json", "astro.config.mjs", "src/content.config.ts", "integrations/sumi-docs-publisher.mjs", "scripts/check-contract-consumers.mjs", "scripts/load-drill.mjs", "scripts/fault-drill.mjs", ...runtimeSources, "docs/index.md", "docs/QUICKSTART.md", "docs/CONFIGURATION.md", "docs/API.md", "docs/AGENT-GUIDE.md", "docs/DEVELOPMENT.md", "docs/CONTRIBUTING.md", "docs/EXTENSIONS.md", "docs/TROUBLESHOOTING.md", "docs/LOCALIZATION.md", "docs/MAINTENANCE.md", "docs/zh-cn/maintenance.md", "docs/ADR-0001-agentic-crm.md", "docs/ADR-0002-protocol-first-generated-client.md", "docs/ADR-0004-runtime-agent-boundary.md", "docs/zh-cn/adr-0004-runtime-agent-boundary.md", "docs/ARCHITECTURE.md", "docs/DATA-MODEL.md", "docs/EVENTS-AUDIT.md", "docs/LIFECYCLE.md", "docs/SECURITY.md", "docs/BUILD-RELEASE.md", "docs/CHECKPOINTS.md", "docs/SOURCE-EVIDENCE.md", "docs/TRACEABILITY.md", "postman/voice-crm.postman_collection.json"];
